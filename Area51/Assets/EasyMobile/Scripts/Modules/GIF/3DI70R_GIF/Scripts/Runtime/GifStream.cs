...
namespace ThreeDISevenZeroR.UnityGifDecoder
{
    ...
    public class GifStream : IDisposable
    {
        ...
        {
            get {return canvas.FlipVertically;}
        ...
        /// </summary>
        public GifHeader Header {get {return header;}}
        ...
        /// </summary>
        public bool HasMoreData {get {return CurrentToken != Token.EndOfFile;}}
        ...
        public GifGraphicControl ReadGraphicsControl()
        {
            ...
            switch (disposalMethodValue)
            {
                ...
                default: throw new ArgumentException(String.Format("Invalid disposal method type: {0}",disposalMethodValue));
            }
