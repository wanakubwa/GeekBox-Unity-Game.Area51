...
namespace EasyMobile.Internal.Privacy
{
    public class EditorConsentDialogUI : MonoBehaviour
    {
        ...
        // Moje eventy do akceptacji i odrzucenia przerz usera gdpr.
        public event Action OnAccept = delegate { };
        public event Action OnDecline = delegate { };
        ...
        protected void NotifyOnAccept()
        {
            OnAccept();
        }

        protected void NotifyOnDecline()
        {
            OnDecline();
        }

        public void NotifyCompleteDefault()
        {
            OnCompleteted(string.Empty, null);
        }
        ...
        public virtual EditorConsentDialogUI Construct(string title, bool isDimissible)
        {
