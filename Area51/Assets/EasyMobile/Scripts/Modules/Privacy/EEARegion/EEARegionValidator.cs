    ...
    public static class EEARegionValidator
    {
        ...
        public static EEACountries GetCurrentCountryCode()
        {
            if (validator == null)
            {
                ...
                return EEACountries.GB;
            }

            EEACountries currentCountry = validator.GetCurrentCountry();
            Debug.LogFormat("EEA - Current country [{0}]", currentCountry);

            return validator.GetCurrentCountry();
        }
