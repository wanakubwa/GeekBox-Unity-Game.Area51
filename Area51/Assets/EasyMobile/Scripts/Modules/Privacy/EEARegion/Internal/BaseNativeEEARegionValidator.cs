...
namespace EasyMobile.Internal.Privacy
{
    internal abstract class BaseNativeEEARegionValidator : IPlatformEEARegionValidator
    {
        ...
        public EEACountries GetCurrentCountry()
        {
            EEACountries result = EEACountries.GB;

            string countryCode = GetCountryCodeViaLocale();
            Enum.TryParse(countryCode, true, out result);
