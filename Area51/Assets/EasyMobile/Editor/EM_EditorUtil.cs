...
namespace EasyMobile.Editor
{
    public static class EM_EditorUtil
    {
        ...
        /// <summary>
        /// Determines if the UnityIAP generated AppleTangle class exists.
        /// </summary>
        ...
        /// <summary>
        /// [Legacy] Determines if the AppleTangle class is not the dummy one we generated.
        /// Previously we use the "IsDummy" property to determine if the tangle class is dummy,
        /// now the dummy class can be identified if it has an EasyMobile namespace instead of UnityEngine.Purchasing.Security.
        /// </summary>
        ...
        /// <summary>
        /// Determines if the dummy AppleTangle generated by EasyMobile exists.
        /// </summary>
        /// <returns></returns>
        public static bool DummyAppleTangleClassExists()
        {
            System.Type appleTangle = FindClass(AppleTangleClassName, EM_Constants.RootNameSpace);
            return (appleTangle != null);
        }

        /// <summary>
        /// Deletes the dummy AppleTangle file if any.
        /// </summary>
        public static void RemoveDummyAppleTangleClass()
        {
            AssetDatabase.DeleteAsset(System.IO.Path.Combine(EM_Constants.DummyReceiptValidationFolder, AppleTangleClassName + ".cs"));
        }

        /// <summary>
        /// Determines if the UnityIAP generated GooglePlayTangle class exists.
        /// </summary>
        /// <returns><c>true</c>, if exists, <c>false</c> otherwise.</returns>
        ...
        /// <summary>
        /// [Legacy] Determines if the GooglePlayTangle class is not the dummy one we generated.
        /// Previously we use the "IsDummy" property to determine if the tangle class is dummy,
        /// now the dummy class can be identified if it has an EasyMobile namespace instead of UnityEngine.Purchasing.Security.
        /// </summary>
        /// <returns><c>true</c> if valid; otherwise, <c>false</c>.</returns>
        ...
        /// <summary>
        /// Determines if the dummy GooglePlayTangle generated by EasyMobile exists.
        /// </summary>
        /// <returns></returns>
        public static bool DummyGooglePlayTangleExists()
        {
            System.Type googlePlayTangle = FindClass(GooglePlayTangleClassName, EM_Constants.RootNameSpace);
            return (googlePlayTangle != null);
        }

        /// <summary>
        /// Deletes the dummy GooglePlayTangle file if any.
        /// </summary>
        public static void RemoveDummyGooglePlayTangleClass()
        {
            AssetDatabase.DeleteAsset(System.IO.Path.Combine(EM_Constants.DummyReceiptValidationFolder, GooglePlayTangleClassName + ".cs"));
        }
        ...
        {
            GenerateClassFromTemplate(EM_Constants.DummyReceiptValidationFolder, AppleTangleClassName, AppleTangleTemplate, alertWhenDone);
        }
        ...
        {
            GenerateClassFromTemplate(EM_Constants.DummyReceiptValidationFolder, GooglePlayTangleClassName, GooglePlayTangleTemplate, alertWhenDone);
        }
